...
public class Player extends Entity{
    ...
    public void draw(Graphics d2){
        // d2.setColor(Color.white);
        // d2.fillRect(x,y, gp.tileSize, gp.tileSize);
        ...
        d2.drawImage(image,x,y,gp.tileSize*3/2,gp.tileSize*3/2,null);
    }
